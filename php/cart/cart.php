                    ...
                    <div class='col-12 col-md-4 col-lg-2 py-2 py-md-3 py-lg-0'>
                        <div class='row'>
                            <form class='d-none' method='post' action='".htmlspecialchars($_SERVER['PHP_SELF'])."' autocomplete='off'>
                                ...
                                <button class='col-3 col-md-2 del btn fw-bold fs-3 px-1' type='submit' name='minus'> - </button>
                            </form>

                            <div class='col-3 col-md-3 fw-bold fs-5 py-3 text-center px-1'><span class='my_text_maincolor border py-2 px-3 rounded-circle'>".$quantity."</span></div>
                            ...
                            <form class='d-none' method='post' action='".htmlspecialchars($_SERVER['PHP_SELF'])."' autocomplete='off'>
                                ...
                                <button class='col-3 col-md-2 del btn fw-bold fs-3 px-3' type='submit' name='plus'> + </button>
                            </form>

                            <form class='d-none' method='post' action='".htmlspecialchars($_SERVER['PHP_SELF'])."' autocomplete='off'>
                                <input type='hidden' name='productId' value='$productId'/>
                                <button class='col-3 col-md-2 del btn fw-bold fs-5 ps-3' type='submit' name='delete'> X </button>
                            </form>
                        </div>
                    </div>
